...
if ($_REQUEST['id']=='') {
$obj->query("insert into tbl_donor_request set name='$name',last_name='$last_name',email='$email',mobile='$mobile',dob='$dob',age='$age',address='$address',blood_group='$blood_group',gender='$gender',user_id='".$_SESSION['user_id']."'",-1);// die();
}else{
  $sql = "update tbl_donor_request set name='$name',last_name='$last_name',email='$email',mobile='$mobile',dob='$dob',age='$age',address='$address',blood_group='$blood_group',gender='$gender',user_id='".$_SESSION['user_id']."' where id='".$_REQUEST['id']."'";
  $obj->query($sql);
