				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">All Donation Requests from users</div>
							</div>
														   ...
														   <?php
															...
															while($line=$obj->fetchNextObject($sql)){?>
																<tr class="odd gradeX">
																	...
																	<td>
																			<?php echo $line->email ?></td>
																	<td>
																			<?php echo $line->pass ?></td>
																	<td>
																		<a href="user-addf.php?id=<?php echo $line->id;?>" class="tblEditBtn">
																			<i class="fa fa-pencil"></i>
																		</a>
																		
																			<a href="request-del.php?user_id=<?php echo $line->id;?>" class="tblDelBtn" >
